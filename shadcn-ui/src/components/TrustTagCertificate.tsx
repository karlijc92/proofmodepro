...
const TrustTagCertificate = React.forwardRef<HTMLDivElement, TrustTagCertificateProps>(
  ({ fullName, certificateType, tagId, dateIssued }, ref) => {
    return (
      <div
        ref={ref}
        className="p-8 bg-white rounded-lg shadow-2xl max-w-2xl mx-auto border-4 border-blue-800 font-sans"
      >
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Verify at proofmode.com/verify?tagId={tagId}
        </p>
      </div>
    );
  }
...
TrustTagCertificate.displayName = 'TrustTagCertificate';
