...
export default function ResumeBuilder() {
  const [resume, setResume] =
    useState<ProofModeResumeData>(emptyResumeData);
  ...
  const updateField = (
    field: keyof ProofModeResumeData,
    value: string
  ) => {
    setResume((current) => ({
      ...current,
  ...
  const saveResume = () => {
    saveResumeToUnifiedProfile(resume);
      ...
      <main className="container mx-auto px-4 py-10">
        <section className="rounded-2xl border bg-card p-6 shadow-sm">
          ...
          <p className="mt-3 max-w-3xl text-muted-foreground">
            Build a stronger resume draft using your experience,
            skills, and future ProofMode TrustTags. This tool helps
            users turn real work history into employer-ready language.
          </p>
        </section>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border bg-card p-6 shadow-sm lg:col-span-2">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Fill this out step by step. Use the examples if you are
          ...
          <aside className="rounded-2xl border bg-background p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Strong resumes use clear, simple proof of what you can
              do.
            </p>
        ...
        <section className="mt-8 rounded-2xl border bg-background p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This is the saved profile version users can keep improving
            over time.
          </p>
          ...
          <div className="mt-6 rounded-2xl border bg-card p-5">
            ...
            <p className="mt-2 text-sm font-medium text-primary">
              {resume.headline ||
                "Your resume headline will appear here"}
            </p>
