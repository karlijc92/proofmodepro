    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <DashboardCard
          ...
          action="Evidence Manager Coming Soon"
          disabled
        />
    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <DashboardCard
          ...
          action="Build Interview Prep Next"
          disabled
        />
        ...
        <DashboardCard
          ...
          action="Build Skill Quizzes Next"
          disabled
        />
  ...
  return (
    <div className="rounded-2xl border bg-background p-5">
      ...
      {showUnsubscribe && (
        <button
          onClick={() => navigate("/contact")}
          className="mt-3 w-full text-sm font-medium text-primary underline"
        >
          Manage or cancel subscription
        </button>
      )}
